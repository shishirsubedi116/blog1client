...
const Page = () => {
  return (
    ...
    <h1 className="text-3xl font-bold mb-4 text-center">Edit Blog</h1>
    <form className="max-w-md mx-auto">
      ...
      <div className="mb-4">
        ...
        <input type="text" id="subTopic" name="subTopic" className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring focus:border-blue-500" value="Sample Sub-topic"/>
      </div>
